      ...
      foreach ($team_members as $member): ?>
        <div class="col-lg-4 col-md-6" data-aos="fade-up">
          <div class="team-member">
            <img src="<?php echo e(asset('img/' . $member['img'])); ?>" alt="<?php echo e($member['name']); ?>">
...
<?php /**PATH C:\HARSHINI\intern\clubportfolio\resources\views/student/commitee.blade.php ENDPATH**/ ?>